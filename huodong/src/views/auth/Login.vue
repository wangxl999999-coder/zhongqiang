  ...
  <div class="min-h-screen bg-gradient-to-br from-primary-500 to-primary-700 flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
      <div class="text-center mb-8">
        ...
        <h1 class="text-2xl font-bold text-gray-800">趣活动</h1>
        <p class="text-gray-500 mt-2">发现更多精彩活动</p>
      </div>
      ...
      <div class="mt-6 text-center">
        ...
        <router-link to="/register" class="text-primary-600 font-medium ml-1">立即注册</router-link>
      </div>
    </div>
  </div>
</template>
